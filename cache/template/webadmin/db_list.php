...
<div class="right">
	<div class="now">
		<a href="webadmin.php?mod=db" class="sel">数据库备份<i></i></a>
		<div class="clear"></div>
	</div>
	...
	<div class="now">
		<a href="webadmin.php?mod=db" class="sel">数据库恢复<i></i></a>
		<div class="clear"></div>
	</div>
	<div class="right_main">
		...
		<tr>
			...
			<td>
				<a href="webadmin.php?mod=db&act=import&dbname=<?php echo $v ?>&token=<?php echo $pe_token ?>" class="admin_edit mar3" onclick="return pe_cfone(this, '导入<?php echo pe_date(strtotime($db_name), 'Y年m月d日 H时i分') ?>备份的数据')">恢复</a>
				<a href="webadmin.php?mod=db&act=del&dbname=<?php echo $v ?>&token=<?php echo $pe_token ?>" class="admin_del" onclick="return pe_cfone(this, '删除')">删除</a>
			</td>
		</tr>
		<?php endforeach;?>
		</table>
