...
switch ($act) {
	...
	case 'view':
		...
		include(pe_tpl('refund_view.html','admin'));
	break;
	//####################// 审核通过 //####################//
	case 'agree':
		$refund_id = pe_dbhold($_g_id);
		...
		include(pe_tpl('refund_agree.html','admin'));
	break;
	//####################// 审核拒绝 //####################//
	case 'refuse':
		$refund_id = pe_dbhold($_g_id);
		...
		include(pe_tpl('refund_refuse.html','admin'));
	break;
	//####################// 确认收货退款 //####################//
	case 'success':
		pe_token_match();
	...
	default:
		...
		include(pe_tpl('refund_list.html','admin'));
	break;
}
?>