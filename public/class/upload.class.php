 ...
 * @creatdate   2010-1001 myllop <myllop@gmail.com>
 */
class upload {
	public $file;
	public $host;//url全路径
	...
	public $filename = '';
	//允许上传的文件类型
	public $filetype = array('jpg','jpeg','gif','png','psd','wps','doc','xls','csv','ppt','pdf','zip','rar','tar','txt','text','mp4','.ogg','.webm');
	//文件上传大小控制(默认是10000kb)
	...
	function __construct($file, $path_save = null, $ext_arr = array())
	{
		...
		!$path_save && $path_save = 'attachment/'.date('Y-m').'/';
